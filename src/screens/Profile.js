    ...
    <ScrollView
      ...
      <View style={styles.header}>
        ...
        <Image
          ...
          source={require('../assets/images/our_team/member-team-4.jpg')}
        />
        <Text
          style={[
            styles.heading,
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              styles.heading,
              {marginTop: 0, fontFamily: 'Montserrat-SemiBold'},
            ]}>
            View Pricing
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.content_box}>
          ...
          <Pressable style={{padding: 3}} onPress={() => setSeeMore(!seeMore)}>
            <Text style={{fontFamily: 'Montserrat', color: Colors.gray}}>
              {seeMoreText}
            </Text>
          </Pressable>
        </View>
        ...
        <View style={styles.content_box}>
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text style={[styles.contact_button_text, {textAlign: 'center'}]}>
                Video call
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.content_box}>
          <View style={{alignItems: 'center', marginVertical: 5}}>
            <Text style={{fontFamily: 'Montserrat-SemiBold', color: 'gray'}}>
              or
            </Text>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.content_box}>
          ...
          <View style={{paddingVertical: 15}}>
            <View
              ...
              <View
                ...
                <Image
                  ...
                  source={require('../assets/images/our_team/member-team-2.jpg')}
                />
            ...
            <Text
              style={{fontFamily: 'Montserrat', color: 'gray', marginTop: 5}}>
          ...
          <View style={{paddingVertical: 15}}>
            <View
              ...
              <View
                ...
                <Image
                  style={{width: 50, height: 50, borderRadius: 25}}
                  source={require('../assets/images/our_team/member-team-3.jpg')}
                />
                <View style={{marginLeft: 5, height: '90%'}}>
                  <Text
                    style={[
          ...
          <View style={{paddingVertical: 15}}>
            <View
              ...
              <View
                ...
                <Image
                  style={{width: 50, height: 50, borderRadius: 25}}
                  source={require('../assets/images/our_team/member-team-5.jpg')}
                />
                <View style={{marginLeft: 5, height: '90%'}}>
                  <Text
                    style={[
