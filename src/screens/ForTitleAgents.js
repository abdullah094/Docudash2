...
const ForTitleAgents = () => {
  return (
    <ScrollView contentContainerStyle={{alignItems:'center',backgroundColor:Colors.white,flex:1}}>
    <BurgerLogoHeader/>

    <ImageBackground style={{width:width,height:220,marginTop:20}} source={require('../assets/images/services/for-businesses-banner.png')} resizeMode='cover'>
...
<Text style={{width:width-80,fontFamily:'Montserrat',fontSize:17,marginTop:20}}>Title agents as users can have complete digital solutions for their professional documents through fluid end-to-end services including e-sign, notarization, document tracing and document verification.</Text>
